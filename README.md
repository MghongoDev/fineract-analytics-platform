...
- **Design rationale:** [`docs/DESIGN_REPORT.md`](docs/DESIGN_REPORT.md) ([PDF](docs/DESIGN_REPORT.pdf) — rebuild with `python scripts/build_design_report_pdf.py`)
...
```
**OR**
The commands can be chained as below:

`pip install -e "ingestion[dev]" && make test && make validate`
